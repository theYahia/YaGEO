...
>
> Актуальная версия того, что лежало здесь: [`skills/yageo/`](https://github.com/theYahia/YaAll/tree/main/skills/yageo)
>
...
> package now lives at [`skills/yageo/`](https://github.com/theYahia/YaAll/tree/main/skills/yageo). Please open issues and pull requests there.
