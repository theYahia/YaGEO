...
Я работаю над **YaGEO** — open-source Claude Code skill для оптимизации сайтов под **Яндекс.Поиск** и **Alice AI** (генеративные ответы). RU-аналог `YaGEO`, заточенный под критерии **ЭПОС** (Экспертность, Полезность, Оригинальность, Содержательность) и официальный Яндекс.Вебмастер-инструмент «Видимость сайта в Алисе AI» (запущен 7 апреля 2026).
